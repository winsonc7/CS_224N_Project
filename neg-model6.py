...
def rate_advice(conversation, advice):
    instructions = (
        """ "You are an expert sales negotiator. You will be provided a sales negotiation conversation between two individuals. You will also be provided a sales negotiation advice generated by another AI assistant.
        Given the context, your task is to rate the quality of the following negotiation advice on a scale of 0 to 10 in four categories:
            1. How specific is the advice to the conversation? (higher score = more specific)
            2. How likely is the advice to be effective? (higher score = more effective)
            3. How actionable and direct is the advice? (higher score = more direct)
            4. How concise is the advice? (higher score = more concise)
        Output your rating of the advice as the average of all 4 scores.
        <Important>
