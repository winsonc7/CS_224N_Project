...
def rate_advice(conversation, advice):
    instructions = (
        """ "You are an expert sales negotiator meant to provide AI feedback for Reinforcement Learning AI Feedback(RLAIF) training. 
        You will be provided a sales negotiation conversation between two individuals. You will also be 
        provided a sales negotiation advice generated by another AI assistant.
        Given the context, your task is to rate the quality of the following negotiation advice on a scale of 0 to 10, considering clarity, conciseness, effectiveness, 
        and professionalism. Provide an average of the rating on all 4 parameters.
        <Important>
...
def generate_llama_advice(conversation, model, tokenizer):
    prompt = (
        f"You are an expert sales negotiator. Given the following negotiation conversation, provide concise advice for the seller on how to proceed. "
        f"Conversation:\n{conversation}\n\nAdvice:"
    )
